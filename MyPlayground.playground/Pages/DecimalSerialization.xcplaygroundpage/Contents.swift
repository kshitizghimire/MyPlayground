...
var serializedDecimal =
    try JSONSerialization.jsonObject(with: decimalData, options: []) as! [String: Any]
...
let serializedDouble =
    try JSONSerialization.jsonObject(with: doubleData, options: []) as! [String: Any]
